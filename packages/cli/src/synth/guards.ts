  ...
  const guards: Array<{ header: string; run: () => string[] }> = [
    {
      ...
      header: 'Stack monolítica (mistura domínios de infra num arquivo só):',
    ...
    },
    {
      ...
      header: 'Handler(s) de Lambda sem arquivo de origem correspondente:',
    ...
    },
    {
      ...
      header: 'Handler(s) com SDK da cloud errada (falharia em runtime):',
    ...
    },
    {
      ...
      header: 'SQL inválido em handler(s):',
    ...
    },
    {
      ...
      header: 'Handler de Lambda em VPC acessa Secrets Manager em runtime (vai dar timeout no deploy):',
    ...
    },
    {
      ...
      header: 'Handler acessa DynamoDB como banco SQL (vai falhar em runtime):',
    ...
    },
    {
      ...
      header: 'Lambda em VPC acessa serviço AWS sem Gateway VPC Endpoint (vai dar timeout no deploy):',
    ...
    },
    {
      ...
      header: 'Handler conecta no PostgreSQL sem SSL (RDS rejeita com "no pg_hba.conf entry ... no encryption"):',
    ...
    },
    {
      ...
      header: "Handler usa process.env que o Fn.Lambda não declara em 'environment' (vai falhar em runtime):",
    ...
    },
    {
      ...
      header: 'Handler consulta um GSI que a tabela DynamoDB não declara (ValidationException em runtime):',
    ...
    },
    {
      ...
      header: 'Handler usa nome reservado do DynamoDB cru numa expressão (ValidationException em runtime):',
    ...
    },
    {
      ...
      header: 'DB_USER hardcoded no Fn.Lambda (a auth do banco falha em runtime):',
      run: () => validateDbUserRef(loadedStacks),
    },
    {
      // Redis Enterprise (Azure) usa TLS na porta 10000 — não existe porta 6379.
      header: "REDIS_PORT hardcoded no Fn.Lambda (Redis Enterprise usa TLS:10000 — '6379' não existe):",
