  ...
  switch (construct.type) {
    ...
    case 'Monitoring.Alarm': {
      ...
      const operatorMap: Record<string, string> = {
        ...
        // Cloud Monitoring só suporta COMPARISON_GT/LT (não GE/LE) — colapsa os
        // "OrEqualTo" no operador estrito mais próximo (o apply rejeita GE/LE:
        // "Unsupported comparison; only COMPARISON_LT and COMPARISON_GT").
        GreaterThanOrEqualToThreshold: 'COMPARISON_GT',
        LessThanOrEqualToThreshold: 'COMPARISON_LT',
      };
      ...
      const filter = [
        ...
        // O Cloud Monitoring EXIGE uma restrição em resource.type no filter
        // (o apply rejeita sem: "must specify a restriction on resource.type").
        // cloud_function é o resource type das métricas cloudfunctions.googleapis.com.
